...
internal class GCPCloudVisionAnalyzer(private val cloudVisionTemplate: CloudVisionTemplate) : OCRAnalyzer {

    private val logger = KotlinLogging.logger { }

    override fun extractTextFrom(resource: Resource, locale: Locale): OCRResponse = try {
