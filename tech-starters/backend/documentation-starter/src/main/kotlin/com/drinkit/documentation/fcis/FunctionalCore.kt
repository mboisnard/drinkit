 ...
 * <ul>
 * <li><b>Purity:</b> Functions should be pure. Given the same input, they must always return the
 * same output without any observable side effects.</li>
 * <li><b>No Side Effects:</b> It must not perform any I/O operations. This includes, but is not
 * limited to: network requests, database access, logging, file system reads/writes, or system
 * clock access.</li>
 * <li><b>Immutability:</b> It should operate on immutable data structures. Instead of modifying
 * input data, it returns new data structures with the updated state.</li>
 * <li><b>Honesty:</b> The function's signature tells the whole story. It takes data in and returns
 * data out, with no hidden dependencies on external state or services.</li>
 * </ul>
 *
 * ## Role in Architecture
 *
 * The Functional Core receives data from the ImperativeShell, processes it, and returns the
