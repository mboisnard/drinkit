...
data class CityLocation(val city: String, val country: Country, val point: Point)

data class FullLocation(val street: String, val city: String, val country: Country, val point: Point?)
