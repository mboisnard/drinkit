...
data class CreateCellarCommand(val name: CellarName, val location: CityLocation, val ownerId: UserId)

@Service
class CreateCellar(private val cellars: Cellars, private val generateId: GenerateId) {
