...
open class UserRecord() : UpdatableRecordImpl<UserRecord>(User.USER) {
     ...
     */
    constructor(id: String? = null, firstname: String? = null, lastname: String? = null, birthdate: LocalDate? = null, email: String? = null, password: String? = null, lastconnection: LocalDateTime? = null, enabled: Boolean? = null, modified: LocalDateTime? = null): this() {
        this.id = id
