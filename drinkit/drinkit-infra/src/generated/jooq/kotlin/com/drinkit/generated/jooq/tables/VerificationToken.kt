...
open class VerificationToken(
     ...
     */
    override fun where(condition: Condition?): VerificationToken = VerificationToken(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): VerificationToken = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): VerificationToken = where(DSL.notExists(select))
}
