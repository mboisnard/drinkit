...
open class Cellar(
     ...
     */
    override fun where(condition: Condition?): Cellar = Cellar(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Cellar = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Cellar = where(DSL.notExists(select))
}
