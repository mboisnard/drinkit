...
* **ADOPT** — Technologies we have high confidence in to serve our purpose, also in large scale. Technologies with a usage culture in the production environment, low risk and recommended to be widely used.
...
::: info
*Text and component code inspired from [Zalando Tech Radar][zalando]*
:::
